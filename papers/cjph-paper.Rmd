...
Even this paper was created using open science principles. We wrote the paper using R markdown - a notebook that allow R code to be executed within the document. The notebook is available on [GitHub](https://github.com/Big-Life-Lab/cchsflow/blob/paper-writeups/papers/cjph-paper.Rmd) which allows readers to make commnents, suggestion or note errors. Reader can execute or modify the examples in this paper.
