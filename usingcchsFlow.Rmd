...
cchsMock2001 <- data.frame(DHHA_SEX = c(2,1,1,6), DHHAGAGE = c(3, 4,6,6)) #FVCADTOT = c(12, 4, 20, 9), RACA_6A = c(2, 1, 2, 2))
cchsMock2013 <- data.frame(DHH_SEX = c(1,2,1), DHHGAGE = c(2, 1, 1)) #FVCDTOT = c(25, 15, 6), ADL_01 = c (2, 2, 2))
```
...
```{r}
agesex_2001 <- bllflow::RecWTable(dataSource = cchsMock2001, variableDetails = varDetails, datasetName = "cchs-82M0013-E-2001-c1-1-general-file", appendToData = FALSE, log = TRUE, variables = c("DHHGAGE_cont", "DHH_SEX"))
print(agesex_2001)
agesex_2013 <- bllflow::RecWTable(dataSource = cchsMock2013, variableDetails = varDetails, datasetName = "cchs-82M0013-E-2013-2014-Annual-component", appendToData = FALSE, log = TRUE, variables = c("DHHGAGE_cont", "DHH_SEX"))
print(agesex_2013)
combinedAgeSex <- rbind(agesex_2001, agesex_2013)
print(combinedAgeSex)
```
...
```{r}
transformed2001 <- bllflow::RecWTable(dataSource = cchsMock2001, variableDetails = varDetails, datasetName = "cchs-82M0013-E-2001-c1-1-general-file", appendToData = FALSE, log = TRUE)
print(transformed2001)
transformed2013 <- bllflow::RecWTable(dataSource = cchsMock2013, variableDetails = varDetails, datasetName = "cchs-82M0013-E-2013-2014-Annual-component", appendToData = FALSE, log = TRUE)
print(transformed2013)
combinedCCHS <- rbind(transformed2001, transformed2013)
print(combinedCCHS)
```