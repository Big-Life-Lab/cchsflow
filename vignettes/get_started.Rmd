...
library(dplyr)
```
## Step 1. Transform variables into harmonized versions
...
The rules for the transformation and harmonization are in two dataframes that are included in 
...
_cchsflow_ includes commonly used sociodemographic, health behaviour and health status variables. In general, variables across CCHS cycles can be grouped into five categories:
