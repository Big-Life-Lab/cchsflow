...
```{r}
cchs_mock2001 <- data.frame(DHHA_SEX = c(2, 1, 1, 6), DHHAGAGE = c(3, 4, 6, 6),
                            FVCADTOT = c(12, 4, 20, 9))
cchs_mock2013 <- data.frame(DHH_SEX = c(1, 2, 1), DHHGAGE = c(2, 1, 1),
                            FVCDTOT = c(25, 15, 6))
```
...
```{r, warning=FALSE}
sex2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
            dataset_name = "cchs2001", variables = c("DHH_SEX"), log = TRUE)
```
...
```{r, warning = FALSE}
sex2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
            dataset_name = "cchs2001", variables = c("DHH_SEX"), append_to_data = FALSE,
            log = TRUE)

sex2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details,
            dataset_name = "cchs2013", variables = c("DHH_SEX"), append_to_data = FALSE,
            log = TRUE)
```
...
```{r, warning=FALSE}
age2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
            dataset_name = "cchs2001", variables = c("DHHGAGE_A"))

age2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details,
            dataset_name = "cchs2013", variables = c("DHHGAGE_B"))
```
...
```{r, warning=FALSE}
age2001_cont <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
                dataset_name = "cchs2001", variables = c("DHHGAGE_cont"))

age2013_cont <- rec_with_table(data = cchs_mock2013, variable_details = variable_details,
                dataset_name = "cchs2013", variables = c("DHHGAGE_cont"))
```
...
```{r, warning=FALSE}
age_sex_2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
                dataset_name = "cchs2001", variables = c("DHHGAGE_cont", "DHH_SEX"),
                var_labels = c(DHHGAGE_cont = "Age", DHH_SEX = "Sex"))

get_label(age_sex_2001)

age_sex_2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details,
                dataset_name = "cchs2013", variables = c("DHHGAGE_cont", "DHH_SEX"),
                var_labels = c(DHHGAGE_cont = "Age", DHH_SEX = "Sex"))
...
```{r, warning=FALSE}
transformed2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details,
...
```{r, warning=FALSE}
transformed2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details,
                    dataset_name = "cchs2013")
```
...
```{r, eval=FALSE}
bmi2003 <- rec_with_table(data = cchs2003, variable_details = variable_details, 
            dataset_name = "cchs2003", variables = c("HWTGHTM", "HWTGWTK",
            "HWTGBMI_der"), log = TRUE)

bmi2010 <- rec_with_table(data = cchs2010, variable_details = variable_details,
            dataset_name = "cchs2010", variables = c("HWTGHTM", "HWTGWTK",
            "HWTGBMI_der"), log = TRUE)
