...
With `rec_with_table()` there are also default arguments that do not need to be called unless you would like to modify them.
  ...
  + `print_note` defaults to TRUE. Information in the `Notes` column from `variable_details.csv` will be displayed
...
```{r, warning=FALSE}
transformed2001 <- rec_with_table(data = cchs2001)

transformed2012 <- rec_with_table(data = cchs2012)
