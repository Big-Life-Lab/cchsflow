...
library(knitr)
library(kableExtra)
kable(variable_details[504:509, 1], col.names = 'variable')
```

2. **dummyVariable:** BMI is a continuous variable, so it does not have dummy variables.

```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:2])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:3])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(504, 509), 1:4])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[505:506, 1:4])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[507:508, 1:4])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(504, 509), 1:5])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[505:506, 1:5])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:6])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:9])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:10])
```

11. **units:** BMI is measured in kg/m^2^, so `kg/m2` is written in each row. 

```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:11])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, 1:12])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[504:509, ])
```
