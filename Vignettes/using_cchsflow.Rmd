...
Don't worry, `cchsflow` is here to help! `variable_details.csv` contains the rules on how to harmonize those two variables into a common variable name. In the CCHS, the categories for `sex` are consistient: 1 = males, 2 = females. `variable_details.csv` provides instructions for how to harmonize category values and labels, if they change across survey cycles. Variable labels are discussed in later vignettes.
