...
`cchs_transformedYear1 <- rec_with_table(data = cchsYear1, variable_details = variable_details, dataset_name = "cchsYear1")`
...
```{r, warning=FALSE}
sex2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001", variables = c("DHH_SEX"), log = TRUE)
```
...
```{r, warning = FALSE}
sex2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001", variables = c("DHH_SEX"), append_to_data = FALSE, log = TRUE)

sex2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details, dataset_name = "cchs2013", variables = c("DHH_SEX"), append_to_data = FALSE, log = TRUE)
```
...
```{r, warning=FALSE}
age2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001", variables = c("DHHGAGE_A"))

age2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details, dataset_name = "cchs2013", variables = c("DHHGAGE_B"))
```
...
```{r, warning=FALSE}
age2001_cont <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001", variables = c("DHHGAGE_cont"))

age2013_cont <- rec_with_table(data = cchs_mock2013, variable_details = variable_details, dataset_name = "cchs2013", variables = c("DHHGAGE_cont"))
```
...
```{r, warning=FALSE}
age_sex_2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001", variables = c("DHHGAGE_cont", "DHH_SEX"), var_labels = c(DHHGAGE_cont = "Age", DHH_SEX = "Sex"))

get_label(age_sex_2001)

age_sex_2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details, dataset_name = "cchs2013", variables = c("DHHGAGE_cont", "DHH_SEX"), var_labels = c(DHHGAGE_cont = "Age", DHH_SEX = "Sex"))
...
```{r, warning=FALSE}
transformed2001 <- rec_with_table(data = cchs_mock2001, variable_details = variable_details, dataset_name = "cchs2001")
```
...
```{r, warning=FALSE}
transformed2013 <- rec_with_table(data = cchs_mock2013, variable_details = variable_details, dataset_name = "cchs2013")
```
...
```{r, eval=FALSE}
bmi2003 <- rec_with_table(data = cchs2003, variable_details = variable_details, dataset_name = "cchs2003", variables = c("HWTGHTM", "HWTGWTK", "HWTGBMI_derived"), log = TRUE)

bmi2010 <- rec_with_table(data = cchs2010, variable_details = variable_details, dataset_name = "cchs2010", variables = c("HWTGHTM", "HWTGWTK", "HWTGBMI_derived"), log = TRUE)
