...
```{r, eval=FALSE}
bmi2003 <- rec_with_table(data = cchs2003, variable_details = variable_details, dataset_name = "cchs2003", variables = c("HWTGHTM", "HWTGWTK", "HWTGBMI_der"), log = TRUE)

bmi2010 <- rec_with_table(data = cchs2010, variable_details = variable_details, dataset_name = "cchs2010", variables = c("HWTGHTM", "HWTGWTK", "HWTGBMI_der"), log = TRUE)
