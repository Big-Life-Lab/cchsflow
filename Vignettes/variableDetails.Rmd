...
## `variableDetails.csv`
The **variableDetails** worksheet is the starting point in transforming variables. Information from this worksheet will be used by the `RecWTable` function of the `bllflow` package to harmonize CCHS variables between cycles. The two components of this worksheets are the **rows** and the **columns.**
