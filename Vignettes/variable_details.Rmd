...
kable(variable_details[c(180:184), 1], col.names = 'variable')
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:2)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:5)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:6)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:7)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:8)])
```

9. **catLabel:** short form label describing the category of a particular variable.

```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:9)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:10)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:11)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:12)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:13)])
```

14. **variableStartShortLabel:** short form label describing the variable.

```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:14)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:15)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(variable_details[c(180:184), c(1:16)])
```
