...
library(knitr)
library(kableExtra)
varDetails <- read.csv(file.path(getwd(), '../inst/extdata/variable_details.csv'))
datatable(varDetails, options = list(pageLength = 5))
cat("In the `variable_details.csv` worksheet there are", nrow(varDetails), "rows and", ncol(varDetails), "columns", "\n\n")
```
...
kable(varDetails[c(75:79), 1], col.names = 'variable')
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:2)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:5)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:6)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:7)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:10)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:11)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:12)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:15)])
```
...
```{r, echo=FALSE, warning=FALSE}
kable(varDetails[c(75:79), c(1:16)])
```
