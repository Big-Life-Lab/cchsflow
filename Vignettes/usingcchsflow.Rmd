...
In the above code, `SetDataLabels()` is used to labelled the combined age and sex dataset. Similar to before, you can check if labels have been added using `get_label()`.
