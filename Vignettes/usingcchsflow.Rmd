...
library(devtools)
install_github("Big-Life-Lab/bllflow", ref = "recode-with-table")
```
...
### Step 2. Create a transformed dataset for each CCHS cycle
...
### Step 3. Combine transformed datasets into a single dataset 
...
#### Option 2: transform the categorical `age` variable into a continuous `age` variable
...
### Step 4. Label variables your final dataset
...
### Example 5. Transform all variables in the variable details sheet
