...
BMI2010 <- RecWTable(dataSource = cchs2003, variableDetails = variableDetails, datasetName = "cchs-82M0013-E-2003-c2-1-General File", log = TRUE, variables = c("HWTGHTM", "HWTGWTK"), varLabels = c(HWTGHTM = "Height", HWTGWTK = "Weight"))
