...
This vignette describes how the `variables.csv` worksheet is organized and how to find variables that you can transform. See also the vignette `variableDetails.csv`. The vignette [Using cchsflow](https://big-life-lab.github.io/cchsflow/articles/usingcchsflow.html) provides examples of how to use the two worksheeets with the [`bllflow` package](http://bllflow.projectbiglife.ca). 
