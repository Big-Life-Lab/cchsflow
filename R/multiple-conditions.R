multiple_conditions_fun <- 
  function(CCC_121,CCC_131,CCC_151,CCC_171,CCC_280,resp_condition,CCC_051){
    ...
    # verify for NA
    if_else2(is.na(CCC_121), 0, CCC_121)
    if_else2(is.na(CCC_131), 0, CCC_131)
    if_else2(is.na(CCC_151), 0, CCC_151)
    if_else2(is.na(CCC_171), 0, CCC_171)
    if_else2(is.na(CCC_280), 0, CCC_280)
    if_else2(is.na(resp_condition), 0, resp_condition)
    if_else2(is.na(CCC_051), 0, CCC_051)
    ...
    ifelse(conditions>= 5, "5+", conditions)
  }