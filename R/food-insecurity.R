...
#' 
#' library(cchsflow)
#' food_insecurity2001 <- rec_with_table(data_source = cchs2001, 
#'    variable_details = variableDetails, dataset_name = "cchs2001",
#'    variables = c("FINF1", "food_insecurity_der"))
#' head(food_insecurity2001)
#' 
#' food_insecurity2005 <- rec_with_table(data_source = cchs2005, 
#'    variable_details = variableDetails, dataset_name = "cchs2005",
#'    variables = c("FSCDHFS", "food_insecurity_der"))
...
#' 
#' food_insecurity2007 <- rec_with_table(data_source = cchs2007_2008, 
#'    variable_details = variableDetails, dataset_name = "cchs2007_2008",
#'    variables = c("FSCDHFS2", "food_insecurity_der"))
...
#' head(food_insecurity2001)
#' 
#' food_insecurity2014 <- rec_with_table(data_source = cchs2014, 
#'    variable_details = variableDetails, dataset_name = "cchs2014",
#'    variables = c("FSCDHFS2", "food_insecurity_der"))
