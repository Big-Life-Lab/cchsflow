...
active_transport1_fun <-
  function(PAC_4A_cont, PAC_4B_cont) {
    if_else2(
      !is.na(PAC_4A_cont) & !is.na(PAC_4B_cont),
      (PAC_4A_cont + PAC_4B_cont) / 7,
      if_else2(
        is.na(PAC_4A_cont), PAC_4B_cont / 7,
        if_else2(
          is.na(PAC_4B_cont), PAC_4A_cont / 7,
          if_else2(
            PAC_4A_cont == "NA(a)" & PAC_4B_cont == "NA(a)",
  ...
  function(PAC_7, PAC_7A, PAC_7B_cont, PAC_8, PAC_8A, PAC_8B_cont) {
    ...
    walk <-
      if_else2(
        PAC_7 == 2, 0,
        if_else2(
          PAC_7 == 1 & !is.na(PAC_7A) & !is.na(PAC_7B_cont),
    ...
    bike <-
      if_else2(
        PAC_8 == 2, 0,
        if_else2(
          PAC_8 == 1 & !is.na(PAC_8A) & !is.na(PAC_8B_cont),
...
active_transport3_fun <-
  function(PAYDVTTR, PAADVTRV) {
    if_else2(
      !is.na(PAYDVTTR) & !is.na(PAADVTRV),
      (PAYDVTTR + PAADVTRV) / 7,
      if_else2(
        is.na(PAYDVTTR), PAADVTRV / 7,
        if_else2(
          is.na(PAADVTRV), PAYDVTTR / 7,
          if_else2(
            PAYDVTTR == "NA(a)" & PAADVTRV == "NA(a)",
            tagged_na("a"), tagged_na("b")
          )
        )
      )
