...
#'
#' @description This function creates a continuous derived variable (SMKG040_fun)
#' that calculates the approximate age that a daily or former daily smoker began 
#' smoking daily. 
#'
...
#' (daily/former daily) combines the two previous variables.As such, age started 
#' smoking daily - daily/former daily smokers has a large number of missing 
#' respondents for CCHS 2015 survey cycles and onward.SMKG040_fun takes the
#' continuous functions (SMKG203_cont and SMKG207_cont) to create SMKG040 for 
#' 2001-2014.
#'
#' @param SMKG203_cont age started smoking daily. Variable asked to daily
#'  smokers.
...
#'
#' combined_age_smoke_dfd <- suppressWarnings(merge_rec_data(age_smoke_dfd_2009_2010,
#'  age_smoke_dfd_2011_2012))
#'
