...
#'
#' library(cchsflow)
#' conditions_2001 <- suppressWarnings(rec_with_table(
#'   cchs2001_p,
#'   c(
...
#'
#' library(cchsflow)
#' num_conditions <- multiple_conditions_fun1(
#'   CCC_121 = 1, CCC_131 = 2,
...
#'
#' library(cchsflow)
#' conditions_2009_2010 <- suppressWarnings(rec_with_table(
#'   cchs2009_2010_p,
#'   c(
#'     "DHHGAGE_cont", "CCC_091",
...
#'
#' library(cchsflow)
#' num_conditions <- multiple_conditions_fun2(
#'   CCC_121 = 1, CCC_131 = 2,
