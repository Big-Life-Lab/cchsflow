...
age_cat_fun <- function(DHHGAGE_cont) {
  if_else2((DHHGAGE_cont %in% 12:14), 1,
  if_else2((DHHGAGE_cont %in% 15:17), 2,
  if_else2((DHHGAGE_cont %in% 18:19), 3,
  if_else2((DHHGAGE_cont %in% 20:24), 4,
  if_else2((DHHGAGE_cont %in% 25:29), 5,
  if_else2((DHHGAGE_cont %in% 30:34), 6,
  if_else2((DHHGAGE_cont %in% 35:39), 7,
  if_else2((DHHGAGE_cont %in% 40:44), 8,
  if_else2((DHHGAGE_cont %in% 45:49), 9,
  if_else2((DHHGAGE_cont %in% 50:54), 10,
  if_else2((DHHGAGE_cont %in% 55:59), 11,
  if_else2((DHHGAGE_cont %in% 60:64), 12,
  if_else2((DHHGAGE_cont %in% 65:69), 13,
  if_else2((DHHGAGE_cont %in% 70:74), 14,
  if_else2((DHHGAGE_cont %in% 75:79), 15,
