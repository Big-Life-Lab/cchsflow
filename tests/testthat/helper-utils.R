...
#' deps <- get_variable_dependencies(
#'   "HWTGBMI_der", "cchs2015_2016_p",
...
#' test_spec <- get_variable_dependencies(
#'   "HWTGBMI_der", "cchs2015_2016_p",
...
#' all_raw_vars <- unique(unlist(lapply(
#'   project_vars, get_variable_dependencies,
