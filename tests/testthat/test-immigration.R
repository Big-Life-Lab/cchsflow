...
test_that("pct_time_fun_A has expected output when age is out of range", {
  expect_equal(pct_time_fun_A(-1, 2, 10), tagged_na("b"))
})

test_that("pct_time_fun_A has expected output when
          immigrant status is out of range", {
  expect_equal(pct_time_fun_A(20, 3, 10), tagged_na("b"))
})
...
test_that("pct_time_fun_A has expected output when age is NA", {
  expect_equal(pct_time_fun_A(NA, 2, 10), tagged_na("b"))
})

test_that("pct_time_fun_A has expected output when immigrant status is NA", {
  expect_equal(pct_time_fun_A(20, NA, 10), tagged_na("b"))
})

test_that("pct_time_fun_A has expected output when time in Canada is NA", {
  expect_equal(pct_time_fun_A(20, 2, NA), tagged_na("b"))
})

test_that("pct_time_fun_A has expected output when all arguments are NA", {
  expect_equal(pct_time_fun_A(NA, NA, NA), tagged_na("b"))
})
